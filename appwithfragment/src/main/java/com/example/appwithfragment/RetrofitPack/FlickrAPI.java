...
public interface FlickrAPI {
    /*take photos*/
    @GET("/services/rest/")
    Call<PhotosApi> getPhotos(@QueryMap Map<String, String> params, @Query("per_page") String perPage, @Query("page") String page);
    ...
    @GET("/services/rest/")
    Call<PhotosApi> getPhotosTags(@QueryMap Map<String, String> params, @Query("cluster_id") String cluster_id);
